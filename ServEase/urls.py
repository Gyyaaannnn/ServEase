...
urlpatterns = [
    ...
    path('new_service_provider',New_Service_provider,name="new_service_provider"),
    path('all_service_provider',All_Service_provider,name="all_service_provider"),
    ...
    path('delete_service_provider(<int:pid>)',delete_Service_provider,name="delete_service_provider"),
